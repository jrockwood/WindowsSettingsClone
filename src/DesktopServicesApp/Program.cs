...
namespace WindowsSettingsClone.DesktopServicesApp
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var bridge = new UwpCommunicationBridge();
            ...
            if (!success)
            {
                ColoredConsole.WriteError("Error in establishing app service connection");
                return;
            }

            ColoredConsole.WriteSuccess("Successfully established app service connection");
